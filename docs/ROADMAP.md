...
| PC2-4 Research universe | Dividend-stock category доступна только через source-backed versioned policy | Source contracts + policy/capability/negative/live-read-only gates | active |
